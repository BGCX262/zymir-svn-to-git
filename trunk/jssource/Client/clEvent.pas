...
Try //程序自动增加
   ...
   m_nLight := 0;
Except //程序自动增加
  DebugOutStr('[Exception] TClEvent.Create'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
   inherited Destroy;
Except //程序自动增加
  DebugOutStr('[Exception] TClEvent.Destroy'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TClEvent.DrawEvent'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TClEvent.Run'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TClEventManager.Create'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
  ...
  inherited Destroy;
Except //程序自动增加
  DebugOutStr('[Exception] TClEventManager.Destroy'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
  ...
  EventList.Clear;
Except //程序自动增加
  DebugOutStr('[Exception] TClEventManager.ClearEvents'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
  ...
  Result := evn;
Except //程序自动增加
  DebugOutStr('[Exception] TClEventManager.AddEvent'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TClEventManager.DelEvent'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TClEventManager.DelEventById'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TClEventManager.GetEvent'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TClEventManager.Execute'); //程序自动增加
End; //程序自动增加
end;
