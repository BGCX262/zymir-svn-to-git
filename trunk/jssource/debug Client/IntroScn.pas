...
Try //程序自动增加
   SceneType := scenetype;
Except //程序自动增加
  DebugOutStr('[Exception] TScene.Create'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
Except //程序自动增加
  DebugOutStr('[Exception] TScene.Initialize'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
Except //程序自动增加
  DebugOutStr('[Exception] TScene.Finalize'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
   ;
Except //程序自动增加
  DebugOutStr('[Exception] TScene.OpenScene'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
   ;
Except //程序自动增加
  DebugOutStr('[Exception] TScene.CloseScene'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
Except //程序自动增加
  DebugOutStr('[Exception] TScene.OpeningScene'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
Except //程序自动增加
  DebugOutStr('[Exception] TScene.KeyPress'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
Except //程序自动增加
  DebugOutStr('[Exception] TScene.KeyDown'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
Except //程序自动增加
  DebugOutStr('[Exception] TScene.MouseMove'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
Except //程序自动增加
  DebugOutStr('[Exception] TScene.MouseDown'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
   ;
Except //程序自动增加
  DebugOutStr('[Exception] TScene.PlayScene'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TIntroScene.Create'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
   inherited Destroy;
Except //程序自动增加
  DebugOutStr('[Exception] TIntroScene.Destroy'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
Except //程序自动增加
  DebugOutStr('[Exception] TIntroScene.OpenScene'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
Except //程序自动增加
  DebugOutStr('[Exception] TIntroScene.CloseScene'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
Except //程序自动增加
  DebugOutStr('[Exception] TIntroScene.PlayScene'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TLoginScene.Create'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
   inherited Destroy;
Except //程序自动增加
  DebugOutStr('[Exception] TLoginScene.Destroy'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TLoginScene.OpenScene'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
   ...
   SilenceSound;
Except //程序自动增加
  DebugOutStr('[Exception] TLoginScene.CloseScene'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TLoginScene.EdLoginIdKeyPress'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TLoginScene.EdLoginPasswdKeyPress'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
   ...
   m_EdId.SetFocus;
Except //程序自动增加
  DebugOutStr('[Exception] TLoginScene.PassWdFail'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TLoginScene.NewIdCheckNewId:'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TLoginScene.NewIdCheckSSno:'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TLoginScene.NewIdCheckBirthDay:'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TLoginScene.EdNewIdKeyPress'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TLoginScene.EdNewOnEnter'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TLoginScene.HideLoginBox'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TLoginScene.OpenLoginDoor'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TLoginScene.PlayScene'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TLoginScene.ChangeLoginState'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TLoginScene.NewClick'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TLoginScene.NewIdRetry'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TLoginScene.UpdateAccountInfos'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TLoginScene.OkClick'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TLoginScene.ChgPwClick'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
   ...
   Result := TRUE;
Except //程序自动增加
  DebugOutStr('[Exception] TLoginScene.CheckUserEntrys:'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TLoginScene.NewAccountOk'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TLoginScene.NewAccountClose'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TLoginScene.ChgpwOk'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
   ChangeLoginState (lsLogin);
Except //程序自动增加
  DebugOutStr('[Exception] TLoginScene.ChgpwCancel'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TSelectChrScene.Create'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
   inherited Destroy;
Except //程序自动增加
  DebugOutStr('[Exception] TSelectChrScene.Destroy'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TSelectChrScene.OpenScene'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TSelectChrScene.CloseScene'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TSelectChrScene.SoundOnTimer'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TSelectChrScene.SelChrSelect1Click'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TSelectChrScene.SelChrSelect2Click'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TSelectChrScene.SelChrStartClick'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TSelectChrScene.SelChrNewChrClick'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TSelectChrScene.SelChrEraseChrClick'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TSelectChrScene.SelChrCreditsClick'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
   FrmMain.Close;
Except //程序自动增加
  DebugOutStr('[Exception] TSelectChrScene.SelChrExitClick'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TSelectChrScene.ClearChrs'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
   ...
   ChrArr[n].Valid := TRUE;
Except //程序自动增加
  DebugOutStr('[Exception] TSelectChrScene.AddChr'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TSelectChrScene.MakeNewChar'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TSelectChrScene.EdChrnameKeyPress'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TSelectChrScene.SelectChr'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TSelectChrScene.SelChrNewClose'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TSelectChrScene.SelRenewChr'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TSelectChrScene.SelChrNewOk'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TSelectChrScene.SelChrNewJob'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TSelectChrScene.SelChrNewm_btSex'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
Except //程序自动增加
  DebugOutStr('[Exception] TSelectChrScene.SelChrNewPrevHair'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
Except //程序自动增加
  DebugOutStr('[Exception] TSelectChrScene.SelChrNewNextHair'); //程序自动增加
End; //程序自动增加
end;
...
//      MSurface.Draw (0, 0, d.ClientRect, d, FALSE);
   ...
   for n:=0 to 1 do begin
      if ChrArr[n].Valid then begin
         ...
         with MSurface do begin
            SetBkMode (Canvas.Handle, TRANSPARENT);
            if BO_FOR_TEST then svname := '测试服务器'
...
Except //程序自动增加
  DebugOutStr('[Exception] TSelectChrScene.PlayScene'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TLoginNotice.Create'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
   inherited Destroy;
Except //程序自动增加
  DebugOutStr('[Exception] TLoginNotice.Destroy'); //程序自动增加
End; //程序自动增加
end;
