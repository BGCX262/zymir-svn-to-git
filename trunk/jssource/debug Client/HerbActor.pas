...
Try //程序自动增加
   inherited Create;
Except //程序自动增加
  DebugOutStr('[Exception] TKillingHerb.Create'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
   inherited Destroy;
Except //程序自动增加
  DebugOutStr('[Exception] TKillingHerb.Destroy'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TKillingHerb.CalcActorFrame'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TKillingHerb.GetDefaultFrame'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TBeeQueen.CalcActorFrame'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TBeeQueen.GetDefaultFrame'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TCentipedeKingMon.CalcActorFrame'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TCastleDoor.Create'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TCastleDoor.ApplyDoorState'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TCastleDoor.LoadSurface'); //程序自动增加
End; //程序自动增加
end;
      ...
      SM_DEATH:
         ...
         begin
            if m_btDir < 3 then begin
               ...
               m_nStartFrame := pm.ActCritical.start;  //凯妨乐绰 惑怕
               m_nEndFrame := m_nStartFrame;
               m_nDefFrameCount := 0;
...
Except //程序自动增加
  DebugOutStr('[Exception] TCastleDoor.CalcActorFrame'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TCastleDoor.GetDefaultFrame'); //程序自动增加
End; //程序自动增加
end;
...
begin
Try //程序自动增加
   if m_nCurrentAction = SM_DIGUP then begin  //巩凯覆
      BoDoorOpen := TRUE;
      m_boHoldPlace := FALSE;
   end;
...
//      DefaultMotion;
Except //程序自动增加
  DebugOutStr('[Exception] TCastleDoor.ActionEnded'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
   ...
   inherited Run;
Except //程序自动增加
  DebugOutStr('[Exception] TCastleDoor.Run'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TCastleDoor.DrawChr'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
   ...
   //DownDrawLevel := 1;
Except //程序自动增加
  DebugOutStr('[Exception] TWallStructure.Create'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TWallStructure.CalcActorFrame'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TWallStructure.LoadSurface'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
   ...
   if pm = nil then exit;
    Result := pm.ActStand.start + m_btDir; // * (pm.ActStand.frame + pm.ActStand.skip);
Except //程序自动增加
  DebugOutStr('[Exception] TWallStructure.GetDefaultFrame'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TWallStructure.DrawChr'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
   ...
   inherited Run;
Except //程序自动增加
  DebugOutStr('[Exception] TWallStructure.Run'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TMineMon.CalcActorFrame'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TMineMon.Create'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TCentipedeKingMon.DrawEff'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
  if m_boUseEffect then
    AttackEffectSurface := GetMonEx(15-1).GetCachedImage (
                        ...
                        ax, ay);
Except //程序自动增加
  DebugOutStr('[Exception] TCentipedeKingMon.LoadEffect'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
   ...
   LoadEffect();
Except //程序自动增加
  DebugOutStr('[Exception] TCentipedeKingMon.LoadSurface'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TMineMon.GetDefaultFrame'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
  ...
  inherited CalcActorFrame;
Except //程序自动增加
  DebugOutStr('[Exception] TBigHeartMon.CalcActorFrame'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
  ...
  inherited CalcActorFrame;
Except //程序自动增加
  DebugOutStr('[Exception] TSpiderHouseMon.CalcActorFrame'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
  ...
  inherited;
Except //程序自动增加
  DebugOutStr('[Exception] TCentipedeKingMon.Run'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
  ...
  m_dwStartTime:=GetTickCount();
Except //程序自动增加
  DebugOutStr('[Exception] TDragonBody.CalcActorFrame'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TDragonBody.DrawEff'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
  DebugOutStr('[Exception] TDragonBody.LoadSurface'); //程序自动增加
End; //程序自动增加
end;
