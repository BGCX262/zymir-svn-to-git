...
Except //程序自动增加
 // DebugOutStr('[Exception] Unwmutil.WidthBytes'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
//  DebugOutStr('[Exception] Unwmutil.PaletteFromBmpInfo'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
 // DebugOutStr('[Exception] Unwmutil.CreateDIB256'); //程序自动增加
End; //程序自动增加
end;
...
Try //程序自动增加
   ...
   Result := Bmp;
Except //程序自动增加
//  DebugOutStr('[Exception] Unwmutil.MakeBmp'); //程序自动增加
End; //程序自动增加
end;
...
Except //程序自动增加
//  DebugOutStr('[Exception] Unwmutil.DrawBits'); //程序自动增加
End; //程序自动增加
end;
