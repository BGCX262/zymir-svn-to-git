...
begin
  try
    ...
    begin
      Application.MessageBox('网关地址设置错误！！！',
    ...
    begin
      Application.MessageBox('网关端口设置错误！！！',
        '错误信息', MB_OK + MB_ICONERROR);
    ...
    begin
      Application.MessageBox('管理服务器地址设置错误！！！',
        '错误信息', MB_OK + MB_ICONERROR);
    ...
    begin
      Application.MessageBox('管理服务器端口设置错误！！！',
        '错误信息', MB_OK + MB_ICONERROR);
    ...
    begin
      Application.MessageBox('数据库服务器地址设置错误！！！',
        '错误信息', MB_OK + MB_ICONERROR);
      EditDBAddr.SetFocus;
      exit;
    end;
    ...
    begin
      Application.MessageBox('数据库服务器端口设置错误！！！',
        '错误信息', MB_OK + MB_ICONERROR);
      EditDBPort.SetFocus;
      exit;
    end;
    ...
    begin
      Application.MessageBox('日志服务器地址设置错误！！！',
        '错误信息', MB_OK + MB_ICONERROR);
    ...
    begin
      Application.MessageBox('日志服务器端口设置错误！！！',
        '错误信息', MB_OK + MB_ICONERROR);
    ...
    begin
      Application.MessageBox('游戏主服务器地址设置错误！！！',
        '错误信息', MB_OK + MB_ICONERROR);
    ...
    begin
      Application.MessageBox('游戏主服务器端口设置错误！！！',
        '错误信息', MB_OK + MB_ICONERROR);
...
begin
  try
    ...
    if GameName = '' then
    begin
      Application.MessageBox('游戏名称设置错误！！！',
        '错误信息', MB_OK + MB_ICONERROR);
    ...
    begin
      Application.MessageBox('服务器号设置错误！！！',
        '错误信息', MB_OK + MB_ICONERROR);
    ...
    begin
      Application.MessageBox('服务器数设置错误！！！',
        '错误信息', MB_OK + MB_ICONERROR);
...
begin
  try
    ...
    begin
      Application.MessageBox('行会目录设置错误！！！',
        '错误信息', MB_OK + MB_ICONERROR);
    ...
    begin
      Application.MessageBox('行会文件设置错误！！！',
        '错误信息', MB_OK + MB_ICONERROR);
    ...
    if not DirectoryExists(VentureDir) or (VentureDir[length(VentureDir)] <> '\')
      then
    begin
      Application.MessageBox('Venture目录设置错误！！！',
        '错误信息', MB_OK + MB_ICONERROR);
    ...
    if not DirectoryExists(ConLogDir) or (ConLogDir[length(ConLogDir)] <> '\')
      then
    begin
      Application.MessageBox('登录日志目录设置错误！！！',
        '错误信息', MB_OK + MB_ICONERROR);
    ...
    if not DirectoryExists(CastleDir) or (CastleDir[length(CastleDir)] <> '\')
      then
    begin
      Application.MessageBox('城堡目录设置错误！！！',
        '错误信息', MB_OK + MB_ICONERROR);
    ...
    begin
      Application.MessageBox('配置目录设置错误！！！',
        '错误信息', MB_OK + MB_ICONERROR);
    ...
    begin
      Application.MessageBox('地图目录设置错误！！！',
        '错误信息', MB_OK + MB_ICONERROR);
      EditMapDir.SetFocus;
      exit;
    end;
    if not DirectoryExists(NoticeDir) or (NoticeDir[length(NoticeDir)] <> '\')
      then
    begin
      Application.MessageBox('公告目录设置错误！！！',
        '错误信息', MB_OK + MB_ICONERROR);
    ...
    begin
      Application.MessageBox('插件目录设置错误！！！',
        '错误信息', MB_OK + MB_ICONERROR);
