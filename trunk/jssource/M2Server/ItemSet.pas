...
type
  TfrmItemSet = class(TForm)
    ...
    Label125: TLabel;
    EditLevelItemRate: TSpinEdit;
    GroupBox52: TGroupBox;
    EditLevelItemGoldCount: TSpinEdit;
    Label126: TLabel;
    EditLevelItemGameGoldCount: TSpinEdit;
    Label127: TLabel;
    Label128: TLabel;
    Label129: TLabel;
    TabSheet21: TTabSheet;
    GroupBox53: TGroupBox;
    CheckBoxPlayShowMystery: TCheckBox;
    CheckBoxHeroShowMystery: TCheckBox;
    CheckBoxCloneShowMystery: TCheckBox;
    ...
    procedure EditLevelItemRateChange(Sender: TObject);
    procedure EditLevelItemGoldCountChange(Sender: TObject);
    procedure EditLevelItemGameGoldCountChange(Sender: TObject);
    procedure CheckBoxPlayShowMysteryClick(Sender: TObject);
    procedure CheckBoxHeroShowMysteryClick(Sender: TObject);
    procedure CheckBoxCloneShowMysteryClick(Sender: TObject);
  private
    boOpened: Boolean;
    boModValued: Boolean;
    procedure ModValue();
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.ModValue');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.uModValue');
  end;
end;
...
begin
  try
    ...
    EditNeckLace19SCAddValueMaxLimit.Value :=
    ...
    MainOutMessage('[Exception] TfrmItemSet.Open');
  end;
end;
...
{$IFEND}
    ...
    MainOutMessage('[Exception] TfrmItemSet.ButtonItemSetSaveClick');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditItemExpRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditItemPowerRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.ButtonAddValueSaveClick');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditMonRandomAddValueChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditMakeRandomAddValueChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditWeaponDCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditWeaponDCAddValueRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditWeaponMCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditWeaponMCAddValueRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditWeaponSCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditWeaponSCAddValueRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditDressDCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditDressDCAddValueRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditDressMCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditDressMCAddValueRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditDressSCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditDressSCAddValueRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditDressDCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditDressMCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditDressSCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditNeckLace19DCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditNeckLace19DCAddValueRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditNeckLace19MCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditNeckLace19MCAddValueRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditNeckLace19SCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditNeckLace19SCAddValueRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditNeckLace19DCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditNeckLace19MCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditNeckLace19SCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditNeckLace202124DCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditNeckLace202124DCAddValueRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditNeckLace202124MCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditNeckLace202124MCAddValueRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditNeckLace202124SCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditNeckLace202124SCAddValueRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditNeckLace202124DCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditNeckLace202124MCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditNeckLace202124SCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditArmRing26DCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditArmRing26DCAddValueRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditArmRing26MCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditArmRing26MCAddValueRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditArmRing26SCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditArmRing26SCAddValueRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditArmRing26DCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditArmRing26MCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditArmRing26SCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditRing22DCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditRing22DCAddValueRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditRing22MCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditRing22MCAddValueRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditRing22SCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditRing22SCAddValueRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditRing22DCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditRing22MCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditRing22SCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditRing23DCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditRing23DCAddValueRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditRing23MCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditRing23MCAddValueRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditRing23SCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditRing23SCAddValueRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditRing23DCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditRing23MCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditRing23SCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditHelMetDCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditHelMetDCAddValueRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditHelMetMCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditHelMetMCAddValueRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditHelMetSCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditHelMetSCAddValueRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditHelMetDCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditHelMetMCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditHelMetSCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditGuildRecallTimeChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.ButtonUnKnowItemSaveClick');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.RefUnknowItem');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowRingDCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowRingDCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowRingMCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowRingMCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowRingSCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowRingSCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowRingACAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowRingACAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowRingMACAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowRingMACAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowNecklaceDCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowNecklaceDCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowNecklaceMCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowNecklaceMCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowNecklaceSCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowNecklaceSCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowNecklaceACAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowNecklaceACAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowNecklaceMACAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowNecklaceMACAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowHelMetDCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowHelMetDCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowHelMetMCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowHelMetMCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowHelMetSCAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowHelMetSCAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowHelMetACAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowHelMetACAddRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowHelMetMACAddValueMaxLimitChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUnknowHelMetMACAddRateChange');
  end;
end;
...
begin
  try
    ...
    EditLevelItemRate.Value := g_Config.nLevelItemRate;
    CheckBoxPlayShowMystery.Checked := g_Config.boPlayShowMystery;
    CheckBoxHeroShowMystery.Checked := g_Config.boHeroShowMystery;
    CheckBoxCloneShowMystery.Checked := g_Config.boCloneShowMystery;
    //CheckBoxLevelItemGetGold.Checked:=g_Config.boLevelItemGetGold;
    //CheckBoxLevelItemGetGameGold.Checked:=g_Config.boLevelItemGetGameGold;
    EditLevelItemGoldCount.Value := g_Config.nLevelItemGoldCount;
    EditLevelItemGameGoldCount.Value := g_Config.nLevelItemGameGoldCount;
  except
    MainOutMessage('[Exception] TfrmItemSet.RefShapeItem');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditAttackPosionRateChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditAttackPosionTimeChange');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.CheckBoxUserMoveCanDupObjClick');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.CheckBoxUserMoveCanOnItemClick');
  end;
end;
...
begin
  try
    ...
    MainOutMessage('[Exception] TfrmItemSet.EditUserMoveTimeChange');
  end;
end;

procedure TfrmItemSet.EditLevelItemRateChange(Sender: TObject);
begin
  if not boOpened then
    exit;
  g_Config.nLevelItemRate := EditLevelItemRate.Value;
  ModValue();
end;

procedure TfrmItemSet.EditLevelItemGoldCountChange(Sender: TObject);
begin
  if not boOpened then
    exit;
  g_Config.nLevelItemGoldCount := EditLevelItemGoldCount.Value;
  ModValue();
end;

procedure TfrmItemSet.EditLevelItemGameGoldCountChange(Sender: TObject);
begin
  if not boOpened then
    exit;
  g_Config.nLevelItemGameGoldCount := EditLevelItemGameGoldCount.Value;
  ModValue();
end;

procedure TfrmItemSet.CheckBoxPlayShowMysteryClick(Sender: TObject);
begin
  if not boOpened then
    exit;
  g_Config.boPlayShowMystery := CheckBoxPlayShowMystery.Checked;
  ModValue();
end;

procedure TfrmItemSet.CheckBoxHeroShowMysteryClick(Sender: TObject);
begin
  if not boOpened then
    exit;
  g_Config.boHeroShowMystery := CheckBoxHeroShowMystery.Checked;
  ModValue();
end;

procedure TfrmItemSet.CheckBoxCloneShowMysteryClick(Sender: TObject);
begin
  if not boOpened then
    exit;
  g_Config.boCloneShowMystery := CheckBoxCloneShowMystery.Checked;
  ModValue();
end;
